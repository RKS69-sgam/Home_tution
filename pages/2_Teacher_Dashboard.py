                ...
                for i, row in student_answers.sort_values(by='Date', ascending=False).iterrows():
                    ...
                    with st.form(f"grade_form_{i}"):
                        ...
                        if st.form_submit_button("Save Grade"):
                            sheet_answers = client.open_by_key(MASTER_ANSWER_SHEET_ID).sheet1
                            ...
                            sheet_answers.update_cell(row_id_to_update, marks_col, GRADE_MAP[grade])
                            sheet_answers.update_cell(row_id_to_update, remarks_col, remarks)
...
with report_tab:
    ...
    if df_all_teachers.empty:
        ...
        fig_leaderboard = px.bar(
            ...
            labels={'Salary Points': 'Total Points Earned', 'User Name': 'Teacher'},
            text='Salary Points'
        )
