...
if st.session_state.logged_in:
    ...
    if current_role == "admin":
        ...
        with tab2:
            ...
            df_teachers = load_data(TEACHER_SHEET)
            # --- FIX: This line was incorrectly indented ---
            st.dataframe(df_teachers)
            # (Your full teacher management code for confirming teachers will go here)
    ...
    # --- FIX: 'elif' must be at the same level as the 'if' above ---
        ...
        with grade_tab:
            # ... (Your grade tab code goes here)
            st.subheader("Grade Student Answers")

        with report_tab:
            # ... (Your report tab code goes here)
